...
import "./ShoeHomeBanner.scss";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

function ShoeHomeBanner() {
  ...
  const getAllBanner = () => {
    const config = {
      url: process.env.REACT_APP_BASE_URL + `api/HomeBanners`,
      method: "get",
    };
  ...
  const UpdateAllBanner = () => {
    const config = {
      url: process.env.REACT_APP_BASE_URL + `api/UpdateAllHomeBanner`,
      method: "put",
  ...
  const deleteBanner = (BannerID) => {
    const config = {
      url: process.env.REACT_APP_BASE_URL + `api/HomeBanner/${BannerID}`,
      method: "delete",
    };
  ...
  return (
    <div className="MainHomeDiv">
      <div className="headingdiv">
        <h1>Check ALL Home Banner</h1>
        <button onClick={() => navigate("/CreateHomeBanner")}>
          Add Home Banner
        </button>
      </div>
      <div className="dashboard-container-contact">
        <div className="responses">
          <div className="resonse-head m-0 w-100 row">
            ...
            <div className="response-contact col-4 text-center">
              <div className="name-head d-flex justify-content-center">
                <h6>Image</h6>
              </div>
            </div>
              ...
              productContactDetail?.map((item, index) => {
                return (
                  <div key={index} className="about-response row">
                    ...
                    <div className="about-response-contact-outer col-4 text-center">
                    ...
                    <div className="about-response-purpose-outer col-2 text-center">
                      <div className="about-response-purpose ">
                        <button
                          ...
                          onClick={() =>
                            navigate(`/EditHomeBanner/${item._id}`)
                          }
                        >
                          Edit
                        </button>
